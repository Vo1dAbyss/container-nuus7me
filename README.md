...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nuus7me.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nuus7me.containers.anotherwebservice.com/
...
```
git clone git@github.com:Vo1dAbyss/container-nuus7me.git
cd container-nuus7me
```
...
```
docker attach container-nuus7me
```
